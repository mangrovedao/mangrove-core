...
contract MakerOperations_Test is IMaker, HasMgvEvents {
  ...
  function retract_middle_offer_leaves_a_valid_book_test() public {
    ...
    (ML.OfferStruct memory offer0, ) = mgv.offerInfo(_base, _quote, offer.prev);
    (ML.OfferStruct memory offer1, ) = mgv.offerInfo(_base, _quote, offer.next);
  ...
  function insertions_are_correctly_ordered_test() public {
    ...
    (MgvLib.OfferStruct memory offer, ) = mgv.offerInfo(_base, _quote, ofr0);
    ...
    public
  {
    ...
    (MgvLib.OfferStruct memory offer, ) = mgv.offerInfo(_base, _quote, ofr);
  ...
  function update_offer_next_to_itself_does_not_break_ob_test() public {
    ...
    (MgvLib.OfferStruct memory ofr, ) = mgv.offerInfo(_base, _quote, center);
  ...
  function update_on_retracted_offer_test() public {
    ...
    (MgvLib.OfferStruct memory ofr, MgvLib.OfferDetail memory dtl) = mgv.offerInfo(
      _base,
      _quote,
      offerId
    );
  ...
  function testOBBest(uint id) internal {
    (MgvLib.OfferStruct memory ofr, ) = mgv.offerInfo(_base, _quote, id);
  ...
  function testOBLink(uint left, uint right) internal {
    (MgvLib.OfferStruct memory ofr, ) = mgv.offerInfo(_base, _quote, left);

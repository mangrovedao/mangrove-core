#!/usr/bin/env bash
# Sets variables used by the library scripts based on $CHAIN_NAME and $LIB_DIR
...
DEPLOYMENT_BASE_DIR=$( dirname "$LIB_DIR" )
...
DEPLOYMENT_DIR="${DEPLOYMENT_BASE_DIR}/${DEPLOYMENT_SCRIPT}.s.sol/${CHAIN_ID}/${PACKAGE_VERSION}"

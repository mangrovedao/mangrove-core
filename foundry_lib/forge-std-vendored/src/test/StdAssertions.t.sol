...
contract StdAssertionsTest is Test {
  ...
  function testAssertEq_UintArr_FailEl(uint e1) public {
    vm.assume(e1 != 0);
    uint[] memory a = new uint[](3);
    uint[] memory b = new uint[](3);
    b[1] = e1;
  ...
  function testAssertEq_IntArr_FailEl(int e1) public {
    vm.assume(e1 != 0);
    int[] memory a = new int[](3);
    int[] memory b = new int[](3);
    b[1] = e1;
  ...
  function testAssertEq_UintArrErr_FailEl(uint e1) public {
    vm.assume(e1 != 0);
    uint[] memory a = new uint[](3);
    uint[] memory b = new uint[](3);
    b[1] = e1;
  ...
  function testAssertEq_IntArrErr_FailEl(int e1) public {
    vm.assume(e1 != 0);
    int[] memory a = new int[](3);
    int[] memory b = new int[](3);
    b[1] = e1;
  ...
  function testAssertEq_UintArr_FailLen(uint lenA, uint lenB) public {
    vm.assume(lenA != lenB);
    vm.assume(lenA <= 10000);
    vm.assume(lenB <= 10000);
    uint[] memory a = new uint[](lenA);
    uint[] memory b = new uint[](lenB);
  ...
  function testAssertEq_IntArr_FailLen(uint lenA, uint lenB) public {
    vm.assume(lenA != lenB);
    vm.assume(lenA <= 10000);
    vm.assume(lenB <= 10000);
    int[] memory a = new int[](lenA);
    int[] memory b = new int[](lenB);
  ...
  function testAssertEq_AddressArr_FailLen(uint lenA, uint lenB) public {
    vm.assume(lenA != lenB);
    vm.assume(lenA <= 10000);
    vm.assume(lenB <= 10000);
  ...
  function testAssertEq_UintArrErr_FailLen(uint lenA, uint lenB) public {
    vm.assume(lenA != lenB);
    vm.assume(lenA <= 10000);
    vm.assume(lenB <= 10000);
    uint[] memory a = new uint[](lenA);
  ...
  function testAssertEq_IntArrErr_FailLen(uint lenA, uint lenB) public {
    vm.assume(lenA != lenB);
    vm.assume(lenA <= 10000);
    vm.assume(lenB <= 10000);
    int[] memory a = new int[](lenA);
  ...
  function testAssertEq_AddressArrErr_FailLen(uint lenA, uint lenB) public {
    vm.assume(lenA != lenB);
    vm.assume(lenA <= 10000);
    vm.assume(lenB <= 10000);
    address[] memory a = new address[](lenA);
...
contract TestTest is Test {
  modifier expectFailure(bool expectFail) {
    ...
    if (expectFail) {
      ...
      vm.store(HEVM_ADDRESS, bytes32("failed"), bytes32(uint(0x00)));
    } else {

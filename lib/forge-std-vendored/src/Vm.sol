...
interface Vm {
  ...
  function difficulty(uint) external;
  ...
  function broadcast(uint) external;
  ...
  function startBroadcast(uint) external;
  ...
  function parseUint(string calldata) external returns (uint);

  function parseInt(string calldata) external returns (int);
  ...
  function rememberKey(uint) external returns (address);

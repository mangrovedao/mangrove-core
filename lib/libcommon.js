...
async function marketOrder(
  ...
  console.log(
    "\t",
    chalk.bgGreen.black(`ORDER [${formatToken(wants, await getDecimals(base_sym))}/${formatToken(gives, await getDecimals(quote_sym))}] FULFILLED`),
    "[",
    ...
    "| ", 
    receipt.gasUsed.toString(), "gas used",
    "]\n"
  );
...
function listenOfferLogic(logic, reason = null) {

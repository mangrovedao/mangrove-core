...
import "../MiscToString.sol";
  ...
  function toString(OfferUnpacked memory __unpacked) pure returns (string memory) {
    return string.concat("Offer{","prev: ", vm.toString(__unpacked.prev), ", ", "next: ", vm.toString(__unpacked.next), ", ", "tickTreeIndex: ", toString(__unpacked.tickTreeIndex), ", ", "gives: ", vm.toString(__unpacked.gives),"}");
  }
  ...
  function toString(LocalUnpacked memory __unpacked) pure returns (string memory) {
    return string.concat("Local{","active: ", vm.toString(__unpacked.active), ", ", "fee: ", vm.toString(__unpacked.fee), ", ", "density: ", toString(__unpacked.density), ", ", "tickTreeIndex: ", toString(__unpacked.tickTreeIndex), ", ", "level0: ", toString(__unpacked.level0), ", ", "level2: ", toString(__unpacked.level2), ", ", "offer_gasbase: ", vm.toString(__unpacked.offer_gasbase), ", ", "lock: ", vm.toString(__unpacked.lock), ", ", "best: ", vm.toString(__unpacked.best), ", ", "last: ", vm.toString(__unpacked.last),"}");
  }
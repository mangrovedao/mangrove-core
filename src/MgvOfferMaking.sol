...
contract MgvOfferMaking is MgvHasOffers {
  ...
  */
  ...
  function newOfferByLogPrice(
    ...
    unchecked {
      ...
      writeOffer(pair, ol, ofp, logPrice, false);
  ...
  */
  ...
  function updateOfferByLogPrice(
    ...
    unchecked {
      ...
      writeOffer(pair, ol, ofp, logPrice, true);
  ...
  */
  ...
  function writeOffer(Pair storage pair, OL memory ol, OfferPack memory ofp, int insertionLogPrice, bool update) internal {
    unchecked {
      ...
      Tick insertionTick = TickLib.fromLogPrice(insertionLogPrice, ol.tickScale);
      ...
      if (ofp.oldOffer.isLive()) {
        ...
        */
        ...
        ofp.local =
          dislodgeOffer(pair, ol.tickScale, ofp.oldOffer, ofp.local, !insertionTick.strictlyBetter(ofp.local.tick()));
      }

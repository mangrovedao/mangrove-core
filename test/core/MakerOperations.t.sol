...
contract MakerOperationsTest is MangroveTest, IMaker {
  ...
  function test_fund_newOfferByVolume() public {
  ...
  function test_fund_updateOfferByVolume() public {
  ...
  function test_gasreq_too_high_fails_newOfferByVolume() public {
    uint gasmax = 12;
    mgv.setGasmax(gasmax);
  ...
  function test_low_density_fails_newOfferByVolume() public {
    uint densityFixed = (10 ** 7) << DensityLib.FIXED_FRACTIONAL_BITS;

...
contract MonitorTest is MangroveTest {
  ...
  function test_notify_works_on_success_when_set() public {
    ...
    expectToMockCall(monitor, abi.encodeCall(IMgvMonitor.notifySuccess, (order, $(this), ol)), bytes(""));
  ...
  function test_notify_works_on_fail_when_set() public {
    ...
    expectToMockCall(monitor, abi.encodeCall(IMgvMonitor.notifyFail, (order, $(this),ol)), bytes(""));

...
abstract contract GasTestBaseStored {
  ...
  function newOfferOnAllTestTicks() public virtual {
    ...
    // MIDDLE_TICK is often controlled in tests so leaving it out. mgv.newOfferByTick(base, quote, MIDDLE_TICK, 1 ether, 1_000_000, 0);
  ...
  function newOfferOnAllLowerThanMiddleTestTicks() public virtual {
    ...
    tickOfferIds[LEAF_LOWER_TICK] = mgv.newOfferByTick(base, quote, LEAF_LOWER_TICK, 1 ether, 1_000_000, 0);
    tickOfferIds[LEVEL0_LOWER_TICK] = mgv.newOfferByTick(base, quote, LEVEL0_LOWER_TICK, 1 ether, 1_000_000, 0);
    tickOfferIds[LEVEL1_LOWER_TICK] = mgv.newOfferByTick(base, quote, LEVEL1_LOWER_TICK, 1 ether, 1_000_000, 0);
    tickOfferIds[LEVEL2_LOWER_TICK] = mgv.newOfferByTick(base, quote, LEVEL2_LOWER_TICK, 1 ether, 1_000_000, 0);
  }

  function newOfferOnAllHigherThanMiddleTestTicks() public virtual {
    (AbstractMangrove mgv,, address base, address quote,) = getStored();
    tickOfferIds[LEAF_HIGHER_TICK] = mgv.newOfferByTick(base, quote, LEAF_HIGHER_TICK, 1 ether, 1_000_000, 0);
    tickOfferIds[LEVEL0_HIGHER_TICK] = mgv.newOfferByTick(base, quote, LEVEL0_HIGHER_TICK, 1 ether, 1_000_000, 0);
    tickOfferIds[LEVEL1_HIGHER_TICK] = mgv.newOfferByTick(base, quote, LEVEL1_HIGHER_TICK, 1 ether, 1_000_000, 0);
    tickOfferIds[LEVEL2_HIGHER_TICK] = mgv.newOfferByTick(base, quote, LEVEL2_HIGHER_TICK, 1 ether, 1_000_000, 0);
  }
}
...
contract GasTestBase is MangroveTest, IMaker, GasTestBaseStored {
  ...
  function getStored() internal view override returns (AbstractMangrove, TestTaker, address, address, uint) {
    return (mgv, _taker, $(base), $(quote), _offerId);
  }

...
import {LEAF_POS_SIZE, LEVEL0_SIZE, LEVEL1_SIZE} from "mgv_lib/TickLib.sol";
import "mgv_lib/Debug.sol";

int constant LOW_LOG_PRICE = MIDDLE_LOG_PRICE - 2 * LEAF_POS_SIZE * LEVEL0_SIZE * LEVEL1_SIZE;

...
//     _gas();
//     mgv.updateOfferByTick(olKey, LEVEL1_HIGHER_TICK, 0.1 ether, 100_000, 0, offerId);
//     gas_();
//   }
// }
...
//     (AbstractMangrove mgv,, OLKey memory _olKey, uint offerId) = getStored();
//     _gas();
//     mgv.updateOfferByTick(olKey, LEVEL1_HIGHER_TICK, 0.1 ether, 1_000_000, 0, offerId);
//     gas_();
...
//     (AbstractMangrove mgv,, OLKey memory _olKey, uint offerId) = getStored();
//     _gas();
//     mgv.updateOfferByTick(olKey, LEVEL1_HIGHER_TICK, 0.1 ether, 10_000, 0, offerId);
//     gas_();

...
//     3. has two offers
// - higher bin list
//   - bin has higher position in same leaf or level0-3 as ToI
//     - if feasible, given insertion tick
//   - list:
//     1. is empty
//     2. is non-empty
// - lower bin list (in {leaf, level0, level1, level2})
//   - bin has lower position in same leaf or level0-3 as ToI
//     - if feasible, given insertion tick
//   - list:
//     1. is empty
//     2. non-empty

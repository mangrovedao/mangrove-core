...
contract MgvLocalTest is Test2 {
  ...
  function test_pack(bool active, uint fee, Density density, uint binPosInLeaf, Field level2, Field level1, Field level0, Field root, uint kilo_offer_gasbase, bool lock, uint last) public {
    MgvStructs.LocalPacked packed = MgvStructs.Local.pack(active, fee, density, binPosInLeaf, level2, level1, level0, root, kilo_offer_gasbase, lock, last);
  ...
  */
  ...
  function test_unpack(MgvStructs.LocalPacked packed) public {
    (bool active, uint fee, Density density, uint binPosInLeaf, Field level2, Field level1, Field level0, Field root, uint kilo_offer_gasbase, bool lock, uint last) = packed.unpack();
